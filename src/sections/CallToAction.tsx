...
import gridLinesc from "@/assets/grid-lines.png";
import {
  motion,
  scroll,
  useMotionTemplate,
...
const useRelativeMousePostion = (to: RefObject<HTMLElement>) => {
...
export const CallToAction = () => {
  ...
  const [mouseX, mouseY] = useRelativeMousePostion(borderDivRef);
      ...
      <div className="container">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${gridLinesc.src})`,
            }}
          ></div>
